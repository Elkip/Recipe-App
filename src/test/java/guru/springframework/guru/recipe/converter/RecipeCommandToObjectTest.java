...
import guru.springframework.guru.recipe.domain.Difficulty;
import guru.springframework.guru.recipe.domain.Recipe;

import static org.junit.jupiter.api.Assertions.*;

class RecipeCommandToObjectTest {
    ...
    RecipeCommandToObject converter;


    @BeforeEach
    public void setUp() throws Exception {
        converter = new RecipeCommandToObject(new NotesCommandToObject(),
                new CategoryCommandToObject(),
                new IngredientCommandToObject(new UnitOfMeasureCommandToObject()));
    }
    ...
    public void convert() throws Exception {
        ...
        assertEquals(DIFFICULTY, recipe.getDifficultly());
