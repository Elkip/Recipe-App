...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.getIngredients().add(new Ingredient("Kosher salt", new BigDecimal(".5"), tsUoM));
        guacRecipe.getIngredients().add(new Ingredient("fresh lime juice or lemon juice", new BigDecimal(2), tbUoM));
        guacRecipe.getIngredients().add(new Ingredient("minced red onion or thinly sliced green onion", new BigDecimal(2), tbUoM));
        guacRecipe.getIngredients().add(new Ingredient("serrano chiles, stems and seeds removed, minced", new BigDecimal(2), eachUoM));
        guacRecipe.getIngredients().add(new Ingredient("Cilantro", new BigDecimal(2), tbUoM));
        ...
        tacosRecipe.getIngredients().add(new Ingredient("Ancho Chili Powder", new BigDecimal(2), tsUoM));
        tacosRecipe.getIngredients().add(new Ingredient("Dried Oregano", new BigDecimal(1), tsUoM));
        tacosRecipe.getIngredients().add(new Ingredient("Dried Cumin", new BigDecimal(1), tbUoM));
        tacosRecipe.getIngredients().add(new Ingredient("Sugar", new BigDecimal(1), tsUoM));
        tacosRecipe.getIngredients().add(new Ingredient("Salt", new BigDecimal(".5"), tsUoM));
        tacosRecipe.getIngredients().add(new Ingredient("Clove of Garlic, Choppedr", new BigDecimal(1), eachUoM));
        tacosRecipe.getIngredients().add(new Ingredient("finely grated orange zestr", new BigDecimal(1), tsUoM));
        tacosRecipe.getIngredients().add(new Ingredient("fresh-squeezed orange juice", new BigDecimal(3), tbUoM));
        tacosRecipe.getIngredients().add(new Ingredient("Olive Oil", new BigDecimal(2), tbUoM));
        tacosRecipe.getIngredients().add(new Ingredient("boneless chicken thighs", new BigDecimal(4), tbUoM));
