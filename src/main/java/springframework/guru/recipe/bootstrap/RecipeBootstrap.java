package springframework.guru.recipe.bootstrap;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        Optional<UnitOfMeasure> tbUoMOptional = uomRepository.findByDescription("Tablespoon");

        if (!tbUoMOptional.isPresent())
            throw new RuntimeException("Expected UOM Not Found");

        Optional<UnitOfMeasure> tsUoMOptional = uomRepository.findByDescription("Teaspoon");

        if (!tsUoMOptional.isPresent())
            throw new RuntimeException("Expected UOM Not Found");
        ...
        UnitOfMeasure tbUoM = tbUoMOptional.get();
        UnitOfMeasure tsUoM = tsUoMOptional.get();
        ...
        guacRecipe.setDifficultly(Difficulty.EASY);
        ...
        guacRecipe.getIngredients().add(new Ingredient("Kosher salt", new BigDecimal(".5"), tsUoM, guacRecipe));
        guacRecipe.getIngredients().add(new Ingredient("fresh lime juice or lemon juice", new BigDecimal(2), tbUoM, guacRecipe));
        guacRecipe.getIngredients().add(new Ingredient("minced red onion or thinly sliced green onion", new BigDecimal(2), tbUoM, guacRecipe));
        ...
        guacRecipe.getIngredients().add(new Ingredient("Cilantro", new BigDecimal(2), tbUoM, guacRecipe));
        ...
        tacosRecipe.setDifficultly(Difficulty.MEDIUM);
        ...
        tacosRecipe.getIngredients().add(new Ingredient("Ancho Chili Powder", new BigDecimal(2), tbUoM, tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("Dried Oregano", new BigDecimal(1), tsUoM, tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("Dried Cumin", new BigDecimal(1), tbUoM, tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("Sugar", new BigDecimal(1), tsUoM, tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("Salt", new BigDecimal(".5"), tsUoM, tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("Clove of Garlic, Choppedr", new BigDecimal(1), eachUoM, tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("finely grated orange zestr", new BigDecimal(1), tsUoM, tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("fresh-squeezed orange juice", new BigDecimal(3), tbUoM, tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("Olive Oil", new BigDecimal(2), tbUoM, tacosRecipe));
        tacosRecipe.getIngredients().add(new Ingredient("boneless chicken thighs", new BigDecimal(4), tbUoM, tacosRecipe));
