...
create table notes (id bigint not null auto_increment, notes longtext, recipe_id bigint, primary key (id));
create table recipe (id bigint not null auto_increment, cook_time integer, description varchar(255), difficultly varchar(255), directions longtext, image longblob, prep_time integer, servings integer, source varchar(255), url varchar(255), notes_id bigint, primary key (id));
